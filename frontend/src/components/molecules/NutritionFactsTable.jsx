...
function ProcessNutritionRow (key, value, first_in_group = false) {
  if (typeof value === 'object' && value !== null) {
    ...
    return <TableRow key={key} label={key} amount={value["Amount"]} daily_value={value["Daily Value"]} first_in_group={FIRST_IN_GROUP_NUTRIENTS.includes(key)} />;
  }
  return <TableRow key={key} label={key} amount={value} first_in_group={FIRST_IN_GROUP_NUTRIENTS.includes(key)} />;
}
